/* HA Tools split — ha-baby-tracker v4.1.3 (2026-05-12) — single-tool standalone repo */
(function() {
'use strict';
...
/* === DARK MODE ADDED - old comment below === */
      ...
      <div class="card">
        ...
        <div class="tip-banner" id="tip-banner">
          ...
          <ul>
            ${this._lang === 'pl' ? `
            <li><strong>Zapis danych:</strong> dane zapisywane s\u0105 lokalnie w przegl\u0105darce (browser-scoped storage). Dane nie synchronizuj\u0105 si\u0119 mi\u0119dzy urz\u0105dzeniami.</li>
            ...
            ` : `
            <li><strong>Storage:</strong> data is stored locally in your browser (browser-scoped storage). Data does not sync between devices.</li>
          ...
          <div class="config-section" style="margin-top:20px">
            ...
            <div style="font-size:12px;line-height:1.8;color:var(--bento-text-secondary,#64748B)">
              ...
              <div><strong>${this._lang === 'pl' ? 'Zapis danych:' : 'Storage:'}</strong>
                ${this._lang === 'pl'
                  ? 'Dane zapisywane s\u0105 lokalnie w przegl\u0105darce. Skorzystaj z przycisku <em>Export Data (JSON)</em> aby zrobi\u0107 kopi\u0119.'
                  : 'Data is stored locally in your browser. Use the <em>Export Data (JSON)</em> button to keep a backup.'}
              </div>
            </div>
          </div>
        </div>
